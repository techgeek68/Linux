## Shell Session Initialization Scripts/ Login,Logout Scripts
...
- The behavior of these scripts depends heavily on whether the shell is a login shell or an interactive non login shell:
  - Login Shell:
      Started with authentication (e.g., console login, ssh, su -l or su -).
  - Interactive Non-Login Shell:
      Started without full authentication (e.g., opening a new terminal tab/window in a desktop environment, or running bash from an existing shell).
