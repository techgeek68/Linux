...
- System requirements are excellent for legacy systems with limited RAM (256–512MB).
...
**Components of the CLI**
  - **Shell:** The command interpreter that processes and executes user commands. Common shells include Bash, Zsh, and Fish.
  - **Terminal Emulator**: The application that provides the CLI environment in GUI systems (e.g., GNOME Terminal, Konsole).
  - **Commands:** Individual instructions issued to the shell for various tasks, such as navigating the filesystem or managing processes.
