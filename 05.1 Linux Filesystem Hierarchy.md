...
> Note: Many conventions come from the FHS; implementations may vary across distributions and versions; always confirm on the target system if exact placement matters.
